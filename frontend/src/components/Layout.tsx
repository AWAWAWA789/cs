    ...
    <div className="flex h-screen overflow-hidden bg-surface-base">
      ...
      <aside className="flex w-60 flex-shrink-0 flex-col border-r border-surface-border bg-surface-card">
        <div className="flex h-16 items-center gap-2 px-5">
          ...
          <div>
            <p className="text-sm font-bold text-ink-primary">CSQAQ 量化平台</p>
            <p className="text-[10px] text-ink-muted">手套指数分析系统</p>
          </div>
        </div>
        ...
        <div className="border-t border-surface-border px-5 py-3">
          <p className="text-[10px] text-ink-muted">v0.20.0 · 本地部署</p>
        </div>
      </aside>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-14 flex-shrink-0 items-center gap-4 border-b border-surface-border bg-surface-card px-6">
          <ItemSearchBar className="max-w-md flex-1" placeholder="搜索饰品名称..." />
        </header>
